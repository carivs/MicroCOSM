...
void Indiv::GetNewHIVstate(int ID, double p, double p2)
{
	double Prob1;
	int iy, xx;
	...
	if(CatchUpVaccHIV==1 && HIVstage != 5 && HIVstageE == 5 && CurrYear<=(ImplementYR+16) && CurrYear>=ImplementYR &&
		(AgeExact >= 15.0 && AgeExact < 25.0 && GotVacc==0 && GotVaccOffer==0) && AliveInd == 1 && SexInd==1){
		 GotVaccOffer==1;
...
void Pop::GetPopPyramid()
{
	...
	for (ic = 0; ic<tpp; ic++){
		if (Register[ic].AliveInd == 1 ){
			...
			if(Register[ic].SexInd==0 && Register[ic].AgeExact>=9 && Register[ic].AgeExact<10) {PopPyramid9[3 + ih][ig] += 1;}
...
void Pop::OneYear()
{
	...
	if(CatchUpVaccHIV==1 && CurrYear==ImplementYR){
		RSApop.AssignVacc2020();
	}
	...
	for (ii = 0; ii<CycleS; ii++){
		...
		if (CreateCohort == 1 && (CurrYear == 2016) && (ii ==24) ){ //
...
void Pop::NewBirth(int ID)
{
	...
	if(HPVvacc==1 && WHOvacc==0 && CurrYear>2004){
		...
		else if (r[6]<PropVaccinated[CurrYear-StartYear] && KidA.SexInd==0 && BOYSvacc==1 && CurrYear>=(ImplementYR-9)){
			KidA.GotVacc=1;
			for(ic=7 ; ic<21; ic++){
				if(r[ic]<VaccEfficacy[ic-7]){KidA.VaccinationStatus[ic-7]=1;}	
			}	
...
void Pop::GetHIVtransitions()
{
	...
	for (ic = 0; ic<tpp; ic++){
		r2[ic] = rg.Random();
		if(CurrYear>2019 && CatchUpVaccHIV==1) {fokkit[ic] = rg.Random();}
		else {fokkit[ic]=0.99;}
	}
	...
	for (ic = 0; ic<tpp; ic++){
		if (Register[ic].AliveInd == 1 && Register[ic].HIVstage>0 &&
			...
			Register[ic].VirginInd == 0)){
			Register[ic].GetNewHIVstate(ic + 1, r2[ic], fokkit[ic]);
		}
	}
}
	...
	for (ic = 0; ic<tpp; ic++){
		if (Register[ic].AliveInd == 1 && Register[ic].AgeGroup >= 2){
			if(VaccineWane==1 && Register[ic].GotVacc==1){ 
				...
				//if(ic==35807){ 
				//	cout << CurrYear << " " << ic << " " << Register[ic].GotVacc << " " << Register[ic].ExpVacc << " " << Register[ic].TimeVacc << " " << Register[ic].VaccinationStatus[0]<< endl;}
			}
			if (Register[ic].VirginInd == 0){
...
void ReadRatesByYear()
{
	...
	//for (iy = 0; iy<136; iy++){HAARTaccess[iy] = 0.0;}
}
		...
		if (FixedUncertainty == 1){
			if(CCcalib==1){
				...
				if(ParamCombs==1) {
					...
					RSApop.SaveStageII("StageIIweeks.txt");
					RSApop.SaveStageIII("StageIIIweeks.txt");
					RSApop.SaveStageIV("StageIVweeks.txt");
					RSApop.SaveStageIdiag("StageIdiag.txt");
					RSApop.SaveStageIIdiag("StageIIdiag.txt");
					RSApop.SaveStageIIIdiag("StageIIIdiag.txt");
...
void HPVTransition::GetNewStageF(int ID, double p, int type)
{
	...
	if (is == 10 && Register[ID - 1].DiagnosedCC==0){
			if (p < From10to14) {Register[ID - 1].HPVstageE[xx] = 14;}
				...
				if(Register[ID - 1].HIVstage==0){RSApop.NewCancerDeathNEG[Register[ID - 1].AgeGroup][CurrYear-StartYear] += 1;}
				if(Register[ID - 1].HIVstage>0 && Register[ID - 1].HIVstage!=5){RSApop.NewCancerDeathPOS[Register[ID - 1].AgeGroup][CurrYear-StartYear] += 1;}
				if(Register[ID - 1].HIVstage==5){RSApop.NewCancerDeathART[Register[ID - 1].AgeGroup][CurrYear-StartYear] += 1;}
			}
...
void Indiv::GetNewHPVstate(int ID, double p, int type) 
{
	...
	if ((HPVstage[type] == 0 && HPVstageE[type] == 1) && SexInd==1 ){  //||(HPVstage[type] == 6 && HPVstageE[type] == 1)
	...
	//if(CIN3distribution == 1){
		if (HPVstage[type] == 3 && HPVstageE[type] == 4){
			...
			if(HIVstage==0 && Age50==1){
				...
				WeibullCIN3[type] = static_cast<int> (HPVTransF[type].AveDuration[3]* (1.0/HPVTransF[xx].CIN2_HIV)* pow(-log(rr[0]), 1/HPVTransF[type].CIN3shape));
			}
		}
	...
	if (HPVstage[type] == 5 && HPVstageE[type] == 5 && CurrYear>=ImplementYR){
		if(HIVstage==0){RSApop.WeeksInStageIneg[AgeGroup][CurrYear-ImplementYR] += 1;}
		if(HIVstage>0 && HIVstage!=5){RSApop.WeeksInStageIpos[AgeGroup][CurrYear-ImplementYR] += 1;}
		if(HIVstage==5){RSApop.WeeksInStageIart[AgeGroup][CurrYear-ImplementYR] += 1;}
	}
	if (HPVstage[type] == 8 && HPVstageE[type] == 8 && CurrYear>=ImplementYR){
		if(HIVstage==0){RSApop.WeeksInStageIIneg[AgeGroup][CurrYear-ImplementYR] += 1;}
		if(HIVstage>0 && HIVstage!=5){RSApop.WeeksInStageIIpos[AgeGroup][CurrYear-ImplementYR] += 1;}
		if(HIVstage==5){RSApop.WeeksInStageIIart[AgeGroup][CurrYear-ImplementYR] += 1;}
	}
	if (HPVstage[type] == 9 && HPVstageE[type] == 9 && CurrYear>=ImplementYR){
		if(HIVstage==0){RSApop.WeeksInStageIIIneg[AgeGroup][CurrYear-ImplementYR] += 1;}
		if(HIVstage>0 && HIVstage!=5){RSApop.WeeksInStageIIIpos[AgeGroup][CurrYear-ImplementYR] += 1;}
		if(HIVstage==5){RSApop.WeeksInStageIIIart[AgeGroup][CurrYear-ImplementYR] += 1;}
	}
	if (HPVstage[type] == 10 && HPVstageE[type] == 10 && CurrYear>=ImplementYR){
		if(HIVstage==0){RSApop.WeeksInStageIVneg[AgeGroup][CurrYear-ImplementYR] += 1;}
		if(HIVstage>0 && HIVstage!=5){RSApop.WeeksInStageIVpos[AgeGroup][CurrYear-ImplementYR] += 1;}
		if(HIVstage==5){RSApop.WeeksInStageIVart[AgeGroup][CurrYear-ImplementYR] += 1;}
	}

	if (HPVstage[type] == 5 && HPVstageE[type] == 11){
		RSApop.StageDiag[0][CurrYear-StartYear] += 1;
		if(HIVstage==0){ RSApop.StageIdiag[AgeGroup][CurrYear-StartYear] += 1;}
		if(HIVstage==5){ RSApop.StageIdiag[18+AgeGroup][CurrYear-StartYear] += 1;}
		if(HIVstage>0 && HIVstage!=5){ RSApop.StageIdiag[36+AgeGroup][CurrYear-StartYear] += 1;}
		DiagnosedCC=1;
	...
	if (HPVstage[type] == 8 && HPVstageE[type] == 12){
		...
		if(HIVstage==0){ RSApop.StageIIdiag[AgeGroup][CurrYear-StartYear] += 1;}
		if(HIVstage==5){ RSApop.StageIIdiag[18+AgeGroup][CurrYear-StartYear] += 1;}
		if(HIVstage>0 && HIVstage!=5){ RSApop.StageIIdiag[36+AgeGroup][CurrYear-StartYear] += 1;}
	...
	if (HPVstage[type] == 9 && HPVstageE[type] == 13){
		...
		if(HIVstage==0){ RSApop.StageIIIdiag[AgeGroup][CurrYear-StartYear] += 1;}
		if(HIVstage==5){ RSApop.StageIIIdiag[18+AgeGroup][CurrYear-StartYear] += 1;}
		if(HIVstage>0 && HIVstage!=5){ RSApop.StageIIIdiag[36+AgeGroup][CurrYear-StartYear] += 1;}
	...
	if (HPVstage[type] == 10 && HPVstageE[type] == 14){
		...
		if(HIVstage==0){ RSApop.StageIVdiag[AgeGroup][CurrYear-StartYear] += 1;}
		if(HIVstage==5){ RSApop.StageIVdiag[18+AgeGroup][CurrYear-StartYear] += 1;}
		if(HIVstage>0 && HIVstage!=5){ RSApop.StageIVdiag[36+AgeGroup][CurrYear-StartYear] += 1;}
	...
	if (HPVstage[type] == 11 && HPVstageE[type] == 11){
		...
		if(TimeinStageI > StageIdeath && TimeinStageI < 480 && StageIdeath>0) { //has to die from cancer within 10 years 10*48=480 
			...
			if(HIVstage==0){RSApop.NewCancerDeathNEG[AgeGroup][CurrYear-StartYear] += 1;}
			if(HIVstage>0 && HIVstage!=5){RSApop.NewCancerDeathPOS[AgeGroup][CurrYear-StartYear] += 1;}
			if(HIVstage==5){RSApop.NewCancerDeathART[AgeGroup][CurrYear-StartYear] += 1;}
			HPVstageE[type] = 16;
		}
...
void InitialiseHPV(){
	...
	for (iy = 0; iy<18; iy++){
		for (is = 0; is<136; is++){
			...
			RSApop.NewCancerDeathNEG[iy][is] = 0;
			RSApop.NewCancerDeathPOS[iy][is] = 0;
			RSApop.NewCancerDeathART[iy][is] = 0;
		}
	}

	for (iy = 0; iy<18; iy++){
		for (is = 0; is<101; is++){
			RSApop.WeeksInStageIneg[iy][is] = 0;
			RSApop.WeeksInStageIIneg[iy][is] = 0;
			RSApop.WeeksInStageIIIneg[iy][is] = 0;
			RSApop.WeeksInStageIVneg[iy][is] = 0;
			RSApop.WeeksInStageIart[iy][is] = 0;
			RSApop.WeeksInStageIIart[iy][is] = 0;
			RSApop.WeeksInStageIIIart[iy][is] = 0;
			RSApop.WeeksInStageIVart[iy][is] = 0;
			RSApop.WeeksInStageIpos[iy][is] = 0;
			RSApop.WeeksInStageIIpos[iy][is] = 0;
			RSApop.WeeksInStageIIIpos[iy][is] = 0;
			RSApop.WeeksInStageIVpos[iy][is] = 0;
		}
	}
...
void Pop::AssignVacc2020()
{
	int ic, SimCount2;
	double wane[110000];
	int  seedy;
	seedy = CurrSim * 92 + process_num * 7928 ;
	SimCount2 = (CurrSim - 1) / IterationsPerPC;
		
	CRandomMersenne rg(seedy);
	...
	for (ic = 0; ic < tpp; ic++){
		/*if (Register[ic].AgeGroup == 2 && Register[ic].AliveInd == 1 && Register[ic].SexInd==1){
				Register[ic].GotVaccOffer=1;
				if(fokkit[ic]<PropVaccinatedWHO ){
				...
				if(VaccineWane==1){
					...
					Register[ic].ExpVacc = -48 * VaccDur * log(wane[ic]);
					if(Register[ic].ExpVacc==0){Register[ic].ExpVacc=1;}
					//file << ic << " " << Register[ic].ExpVacc << endl;
		
				} 
				//cout << ic << " " << Register[ic].ExpVacc << endl;
		}*/
		//if(CatchUpVaccHIV==1 && Register[ic].HIVstage>0 && 
		if(CatchUpVaccHIV==1 && Register[ic].HIVstage==5 && 
			(Register[ic].AgeExact >= 15.0 && Register[ic].AgeExact < 25.0) &&
							...
							double SId, double SIId, double SIIId, double SIVd) 
{
	...
	if (AgeGroup==3||AgeGroup==4||AgeGroup==5) { yy = 0;}
	else if (AgeGroup==6||AgeGroup==7) { yy = 1;}
		...
		if(timePassed > timetoScreen && timetoScreen>0 ) {
			...
			if(HPVDNA==0 || CurrYear<ImplementYR) {ScreenAlgorithm(ID, rea, ade, tts, res, ttC, CCd, SI, SII, SIII, SIV, SId, SIId, SIIId, SIVd);}
				...
				if((HIVstage>=5 && AgeExact>=25.0)||(HIVstage<5 && AgeExact>=30.0)){ 
					HPVScreenAlgorithm(ID, rea, ade, tts, res, ttC, CCd, SI, SII, SIII, SIV, SId, SIId, SIIId, SIVd);}
			}
							...
							double SId, double SIId, double SIIId, double SIVd)
{
	...
	if(ade < PapAdequacy[CurrYear-StartYear]){
		...
		//if(HIVstage>0){
			...
			if(TrueStage==3 && ScreenResult == 2 && CCd<0.35 && DiagnosedCC == 0) {  //CCd is sensitivity of Pap to pick up cancer
				DiagnosedCC = 1;
				//ofstream file("age.txt", std::ios::app);
				//file << CurrYear << " " << HIVstage << " " << AgeExact << endl;
				//file.close();	
		...
		if(ScreenResult == 1){
			if(PrevResult==1) { 
				//Refer to colposcopy 
				GetReferred.out[SimCount2][CurrYear-StartYear] += 1;
				if(HIVstage==5) {
		...
		//HSIL/CC screen:
		if (ScreenResult == 2 && DiagnosedCC==0){
			//Refer to colposcopy 
			GetReferred.out[SimCount2][CurrYear-StartYear] += 1;
			if(HIVstage==5) {
				if(ttC<AttendColposcopy[2][CurrYear-StartYear]){
							...
							double SId, double SIId, double SIIId, double SIVd) 
{
	...
	if((S7S11==0 || (S7S11==1 && HIVstage==0)) && scr<WHOcoverage[zz*4 + yy][CurrYear-StartYear]/(10.0*48.0)){
			if(AgeExact>=30.0 && AgeExact<40.0 && Scr35==0){
				Scr35=1;
				if(HIVstage==0) {RSApop.NewHPVScreen[AgeGroup][CurrYear-StartYear] += 1;}
				else if(HIVstage==5) {RSApop.NewHPVScreen[18+AgeGroup][CurrYear-StartYear] += 1;} //||HIVstage==6
				else {RSApop.NewHPVScreen[2*18+AgeGroup][CurrYear-StartYear] += 1;}
	...
	if(S7S11==1 && HIVstage>0 &&  scr<WHOcoverage[zz*4 + yy][CurrYear-StartYear]/(3.0*48.0)) {   
		if(AgeExact>=25.0 && AgeExact<28.0 && Scr25==0){
				Scr25=1;
				if(HIVstage== 5) {RSApop.NewHPVScreen[18+AgeGroup][CurrYear-StartYear] += 1;} //||HIVstage==6
				else {RSApop.NewHPVScreen[2*18+AgeGroup][CurrYear-StartYear] += 1;}	
				WHOScreenAlgorithm(ID, tts, ttC, clr, SI, SII, SIII, SIV, SId, SIId, SIIId, SIVd);
		}
							...
							double SId, double SIId, double SIIId, double SIVd)
{
	...
	if((HPVstage[0]==4||HPVstage[1]==4||HPVstage[2]==4||HPVstage[4]==4||HPVstage[4]==4||HPVstage[5]==4||
		HPVstage[6]==4||HPVstage[7]==4||HPVstage[8]==4||HPVstage[9]==4||HPVstage[10]==4||HPVstage[11]==4||HPVstage[12]==4) &&
		TrueStage < 3 && tts < 0.94 && ttC < 0.9){
			if(HIVstage==0){ RSApop.NewLLETZ[AgeGroup][CurrYear-StartYear] += 1;}
			if(HIVstage==5){ RSApop.NewLLETZ[18+AgeGroup][CurrYear-StartYear] += 1;}
			if(HIVstage>0 && HIVstage!=5){ RSApop.NewLLETZ[2*18 + AgeGroup][CurrYear-StartYear] += 1;}
					if (clr < 0.15){
						for (xx = 0; xx < 13; xx++)	{
	...
	else if((HPVstage[0]==1||HPVstage[1]==1||HPVstage[0]==2||HPVstage[1]==2||
		HPVstage[0]==3||HPVstage[1]==3||HPVstage[2]==1||HPVstage[3]==1||HPVstage[4]==1||HPVstage[5]==1||
		HPVstage[6]==1||HPVstage[7]==1||HPVstage[8]==1||HPVstage[9]==1||HPVstage[10]==1||HPVstage[11]==1||HPVstage[12]==1||
		HPVstage[2]==2||HPVstage[3]==2||HPVstage[4]==2||HPVstage[5]==2||
		HPVstage[6]==2||HPVstage[7]==2||HPVstage[8]==2||HPVstage[9]==2||HPVstage[10]==2||HPVstage[11]==2||HPVstage[12]==2||
		HPVstage[2]==3||HPVstage[3]==3||HPVstage[4]==3||HPVstage[5]==3||
		HPVstage[6]==3||HPVstage[7]==3||HPVstage[8]==3||HPVstage[9]==3||HPVstage[10]==3||HPVstage[11]==3||HPVstage[12]==3) &&
	...
	if(TrueStage==3 && DiagnosedCC==0 && tts < 0.94){
		DiagnosedCC=1;
		RSApop.NewDiagCancer[AgeGroup][CurrYear-StartYear] += 1;
		if(HPVstage[0]==5||HPVstage[0]==8||HPVstage[0]==9||HPVstage[0]==10||
			HPVstage[1]==5||HPVstage[1]==8||HPVstage[1]==9||HPVstage[1]==10) {RSApop.NewDiagCancer1618[AgeGroup][CurrYear-StartYear] += 1;}
							...
							double SId, double SIId, double SIIId, double SIVd)
{
	...
	if (timePassed > timetoCol  ){
		if(HIVstage==0){ RSApop.NewColposcopy[AgeGroup][CurrYear-StartYear] += 1;}
		if(HIVstage==5){ RSApop.NewColposcopy[18+AgeGroup][CurrYear-StartYear] += 1;}
		if(HIVstage>0 && HIVstage!=5){ RSApop.NewColposcopy[2*18 + AgeGroup][CurrYear-StartYear] += 1;}
...
void Pop::SaveNewScreen(const char* filout)
{
	...
	for (iy = 0; iy < 54; iy++){
		for (is = 0; is<136; is++){
			file << right << RSApop.ModelCoverage[iy][is] << "	";
		}
		file << endl;
	}
	for (iy = 0; iy < 54; iy++){
		for (is = 0; is<136; is++){
			file << right << RSApop.ModelVaccCoverage[iy][is] << "	";
		}
		file << endl;
	}
	for (iy = 0; iy < 54; iy++){
		for (is = 0; is<136; is++){
			file << right << RSApop.ModelHPVCoverage[iy][is] << "	";
		}
		file << endl;
	}
	for (iy = 0; iy < 54; iy++){
		for (is = 0; is<136; is++){
			file << right << RSApop.ModelColpCoverage[iy][is] << "	";
		}
		file << endl;
	}
	for (iy = 0; iy < 54; iy++){
		for (is = 0; is<136; is++){
			file << right << RSApop.ModelLLETZCoverage[iy][is] << "	";
		}
		file << endl;
	}
	for (iy = 54; iy < 108; iy++){
...
void ReadLifeTimePartners()
{
	...
	file.open("LifetimePartnersInit.txt");
	for (ia = 0; ia<320; ia++){
		for (iy = 0; iy<2; iy++){
			file >> LTP[ia][iy];
		}
							...
							double SId, double SIId, double SIIId, double SIVd)
{
	...
	//if(repeat==0 ){ RSApop.NewScreen[zz*5 + yy][CurrYear-StartYear] += 1;}
	 RSApop.NewHPVScreen[zz*18 + AgeGroup][CurrYear-StartYear] += 1;
	
	//if test positive with HPV16/18/45 (but not cancer), 90% get immediate treatment
	if((HPVstage[0]==1||HPVstage[1]==1||HPVstage[6]==1||HPVstage[0]==2||HPVstage[1]==2||HPVstage[6]==2||
		HPVstage[0]==3||HPVstage[1]==3||HPVstage[6]==3||HPVstage[0]==4||HPVstage[1]==4||HPVstage[6]==4) && 
		TrueStage<3 && ade<0.95 && tts<0.9){	//95% sensitivity and 10% loss 
			GetTreatment.out[AgeGroup][CurrYear-StartYear] += 1;
			...
			if( PerfectSchedule==0||CurrYear<ImplementYR){
					if(HIVstage==5) {timetoScreen = 4.5 * pow(-log(SI),(1.0/0.71)) * 48;}
					else  { timetoScreen = 9.0 * pow(-log(SI),(1.0/0.56)) * 48; }
					if(timetoScreen==0) {timetoScreen=1;}
			}
			if( PerfectSchedule==1 && CurrYear>=ImplementYR){timetoScreen = 48;}	
			repeat = 1;
	...
	else if((HPVstage[0]==5||HPVstage[1]==5||HPVstage[6]==5||HPVstage[0]==8||HPVstage[1]==8||HPVstage[6]==8||
		HPVstage[0]==9||HPVstage[1]==9||HPVstage[6]==9||HPVstage[0]==10||HPVstage[1]==10||HPVstage[6]==10) && DiagnosedCC==0 && ade<0.95 && tts<0.9){
			DiagnosedCC = 1;
			RSApop.NewDiagCancer[AgeGroup][CurrYear-StartYear] += 1;
			if(HPVstage[0]==5||HPVstage[0]==8||HPVstage[0]==9||HPVstage[0]==10||
					HPVstage[1]==5||HPVstage[1]==8||HPVstage[1]==9||HPVstage[1]==10) {RSApop.NewDiagCancer1618[AgeGroup][CurrYear-StartYear] += 1;}
		...
		HPVstage[2]==1||HPVstage[3]==1||HPVstage[4]==1||HPVstage[5]==1||
		HPVstage[7]==1||HPVstage[8]==1||HPVstage[9]==1||HPVstage[10]==1||HPVstage[11]==1||HPVstage[12]==1||
		HPVstage[2]==2||HPVstage[3]==2||HPVstage[4]==2||HPVstage[5]==2||
		HPVstage[7]==2||HPVstage[8]==2||HPVstage[9]==2||HPVstage[10]==2||HPVstage[11]==2||HPVstage[12]==2||
		HPVstage[2]==3||HPVstage[3]==3||HPVstage[4]==3||HPVstage[5]==3||
		HPVstage[7]==3||HPVstage[8]==3||HPVstage[9]==3||HPVstage[10]==3||HPVstage[11]==3||HPVstage[12]==3||
		HPVstage[2]==4||HPVstage[3]==4||HPVstage[4]==4||HPVstage[5]==4||
		HPVstage[7]==4||HPVstage[8]==4||HPVstage[9]==4||HPVstage[10]==4||HPVstage[11]==4||HPVstage[12]==4||
		HPVstage[2]==5||HPVstage[3]==5||HPVstage[4]==5||HPVstage[5]==5||
		HPVstage[7]==5||HPVstage[8]==5||HPVstage[9]==5||HPVstage[10]==5||HPVstage[11]==5||HPVstage[12]==5||
		HPVstage[2]==8||HPVstage[3]==8||HPVstage[4]==8||HPVstage[5]==8||
		HPVstage[7]==8||HPVstage[8]==8||HPVstage[9]==8||HPVstage[10]==8||HPVstage[11]==8||HPVstage[12]==8||
		HPVstage[2]==9||HPVstage[3]==9||HPVstage[4]==9||HPVstage[5]==9||
		HPVstage[7]==9||HPVstage[8]==9||HPVstage[9]==9||HPVstage[10]==9||HPVstage[11]==9||HPVstage[12]==9||
		HPVstage[2]==10||HPVstage[3]==10||HPVstage[4]==10||HPVstage[5]==10||
		HPVstage[7]==10||HPVstage[8]==10||HPVstage[9]==10||HPVstage[10]==10||HPVstage[11]==10||HPVstage[12]==10) && 
		DiagnosedCC==0 && ade<0.95){
			...
			//Refer to colposcopy 
				...
				if(ade < PapAdequacy[CurrYear-StartYear]){
					...
					if (ScreenResult == 2 && TrueStage<3 && SI<0.9){
						...
						if( PerfectSchedule==0||CurrYear<ImplementYR){
								if(HIVstage==5) {timetoScreen = 4.5 * pow(-log(rea),(1.0/0.71)) * 48;}
								else  { timetoScreen = 9.0 * pow(-log(rea),(1.0/0.56)) * 48; }
								if(timetoScreen==0) {timetoScreen=1;}
						}
						if( PerfectSchedule==1 && CurrYear>=ImplementYR){timetoScreen = 48;}	
						repeat = 1;
							...
							double SId, double SIId, double SIIId, double SIVd) 
{
	...
	if((timetoScreen>0 && timetoScreen<96) && timetoCol==0){
	...
	else if( HIVstage<5 && scr<WHOcoverage[zz*4 + yy][CurrYear-StartYear]/(48.0*10.0)){
		
			if(AgeExact>=30.0 && AgeExact<40.0 && Scr30==0){
				Scr30=1;
				//if(HIVstage==0) {RSApop.NewScreen[AgeGroup][CurrYear-StartYear] += 1;}
				//else {RSApop.NewScreen[2*18+AgeGroup][CurrYear-StartYear] += 1;}
				if(HPVDNA==0 || CurrYear<ImplementYR) {ScreenAlgorithm(ID, rea, ade, tts, res, ttC, CCd, SI, SII, SIII, SIV, SId, SIId, SIIId, SIVd);}
				else if(HPVDNA==1 && CurrYear>=ImplementYR) {HPVScreenAlgorithm(ID, rea, ade, tts, res, ttC, CCd, SI, SII, SIII, SIV, SId, SIId, SIIId, SIVd);}
			}
		...
		if(AgeExact>=15.0 && AgeExact<18.0 && Scr16==0){
			...
			if(HPVDNA==0 || CurrYear<ImplementYR) {
				ScreenAlgorithm(ID, rea, ade, tts, res, ttC, CCd, SI, SII, SIII, SIV, SId, SIId, SIIId, SIVd);
				//RSApop.NewScreen[18+AgeGroup][CurrYear-StartYear] += 1;
			}
		}
...
void Pop::SaveCancerDeaths(const char* filout)
{
	...
	for (ia = 0; ia < 18; ia++){
		for (is = 0; is<136; is++){
			file << right << NewCancerDeathNEG[ia][is] << "	";
		}
		file << endl;
	}
	for (ia = 0; ia < 18; ia++){
		for (is = 0; is<136; is++){
			file << right << NewCancerDeathART[ia][is] << "	";
		}
		file << endl;
	}
	for (ia = 0; ia < 18; ia++){
		for (is = 0; is<136; is++){
			file << right << NewCancerDeathPOS[ia][is] << "	";
		}
		file << endl;
	}
...
void Pop::SaveStageI(const char* filout)
{
	int iy, is;
	...
	for (iy = 0; iy < 18; iy++){
		for (is = 0; is<101; is++){
			file << right << RSApop.WeeksInStageIneg[iy][is] << "	";
		}
		file << endl;
	}
	for (iy = 0; iy < 18; iy++){
		for (is = 0; is<101; is++){
			file << right << RSApop.WeeksInStageIart[iy][is] << "	";
		}
		file << endl;
	}
	for (iy = 0; iy < 18; iy++){
		for (is = 0; is<101; is++){
			file << right << RSApop.WeeksInStageIpos[iy][is] << "	";
		}
		file << endl;
	}
	file.close();
}
void Pop::SaveStageII(const char* filout)
{
	int iy, is;
	...
	for (iy = 0; iy < 18; iy++){
		for (is = 0; is<101; is++){
			file << right << RSApop.WeeksInStageIIneg[iy][is] << "	";
		}
		file << endl;
	}
	for (iy = 0; iy < 18; iy++){
		for (is = 0; is<101; is++){
			file << right << RSApop.WeeksInStageIIart[iy][is] << "	";
		}
		file << endl;
	}
	for (iy = 0; iy < 18; iy++){
		for (is = 0; is<101; is++){
			file << right << RSApop.WeeksInStageIIpos[iy][is] << "	";
		}
		file << endl;
	}
	file.close();
}
void Pop::SaveStageIII(const char* filout)
{
	int iy, is;
	...
	for (iy = 0; iy < 18; iy++){
		for (is = 0; is<101; is++){
			file << right << RSApop.WeeksInStageIIIneg[iy][is] << "	";
		}
		file << endl;
	}
	for (iy = 0; iy < 18; iy++){
		for (is = 0; is<101; is++){
			file << right << RSApop.WeeksInStageIIIart[iy][is] << "	";
		}
		file << endl;
	}
	for (iy = 0; iy < 18; iy++){
		for (is = 0; is<101; is++){
			file << right << RSApop.WeeksInStageIIIpos[iy][is] << "	";
		}
		file << endl;
	}
	file.close();
}
void Pop::SaveStageIV(const char* filout)
{
	int iy, is;
	...
	for (iy = 0; iy < 18; iy++){
		for (is = 0; is<101; is++){
			file << right << RSApop.WeeksInStageIVneg[iy][is] << "	";
		}
		file << endl;
	}
	for (iy = 0; iy < 18; iy++){
		for (is = 0; is<101; is++){
			file << right << RSApop.WeeksInStageIVart[iy][is] << "	";
		}
		file << endl;
	}
	for (iy = 0; iy < 18; iy++){
		for (is = 0; is<101; is++){
			file << right << RSApop.WeeksInStageIVpos[iy][is] << "	";
		}
		file << endl;
	}
	file.close();
...
void Pop::SaveStageIdiag(const char* filout)
{
	int iy, is;
...
void Pop::SaveStageIIdiag(const char* filout)
{
	int iy, is;
...
void Pop::SaveStageIIIdiag(const char* filout)
{
	int iy, is;
...
void Pop::SaveStageIVdiag(const char* filout)
{
	int iy, is;
